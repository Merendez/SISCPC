...
<FORM name="formulario" method="post" action="registro_bienes_funcion.php" >

<input name="camb" type="text" placeholder="camb" id="Texto1" onkeypress="return valida(event)" />

<input name="descripcion" type="text" placeholder="descripcion" id="Texto2" />

...
$result= mysqli_query($link, "select * from compras where idcompras='".$idcompras."'" );
...
<FORM name="formulario" method="post" action="modificar_compras_logica.php?idcompra=$idcompras" >
Fecha </br> 
<input name="fecha" type="text" value="$fecha" id="Texto2" onkeypress="return valida(event)"/>
Cantidad </br> 
<input name="cantidad" type="text" value="$cantidad" id="Texto3" onkeypress="return valida(event)"/>
Precio </br> 
<input name="precio" type="text" value="$precio" id="Texto4" onkeypress="return valida(event)"/>
IdTrabajador </br> 
<input name="idtrabajador" type="text" value="$idtrabajador" id="Texto5" readonly/>
CAMB </br> 

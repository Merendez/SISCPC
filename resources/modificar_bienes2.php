...
<FORM name="formulario" method="post" action="modificar_bienes_logica.php" >
CAMB </br> 
<input name="camb" type="text" value="$camb_obtenido" id="Texto1" onkeypress="return valida(event)"readonly  />
Descripcion </br> 

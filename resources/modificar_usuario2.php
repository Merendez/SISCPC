...
$result= mysqli_query($link, "select * from usuarios where idTrabajador='".$idTrabajador_obtenido."'" );
...
Contrasena </br> 
<input name="contrasena" type="text" value="$contrasena" id="Texto2" />

Tipo</br> 
<input name="tipo" type="text" value="$tipo" id="Texto3" />

Estado</br> 
<input name="estado" type="text" value="$estado" id="Texto3" onkeypress="return valida(event)" onkeypress="return valida(event)" />

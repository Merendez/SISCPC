...
$result=mysql_query("SELECT *, DATEDIFF(CURRENT_DATE(),Gob_Fed)/365 AS Antiguedad FROM trabajador where EXISTS (select * from clave_presupuestal where trabajador.RFC=clave_presupuestal.RFC_trabajador and clave_presupuestal.Denominacion like '%prof%')
...
$estiloTituloReporte = array(
       ...
       // $objDrawing2->getShadow()->setDirection(4);
		...
		header('Content-Disposition: attachment;filename="Plantilla_docente_ITCA.xlsx"');

...
$idcompras_obtenido=$_GET["idcompras"];
$combobit="";
if($idcompras_obtenido== ""){
// obtener los id de los bienes almacenados
...
do{
$combobit.="<option value='".$row['idcompras']."'>".$row['idcompras']."</option>";
...
<form name="form1" action= "./eliminar_compras2.php?idcompras=" method="post">
CAMB:
<select name ="idcompras"> echo $combobit;</select>
<center><input name="validar" type="submit" value = "Validar" /> <br/> </center>
TEXTO;

}//fin if de bien obtenido nulo

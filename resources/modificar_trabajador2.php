...
$contenidodinamico= <<<TEXTO
<FORM name="formulario" method="post" action="./modificar_trabajador_logica.php" >
IdTrabajador </br> 
...
Telefono</br> 
<input name="telefono" type="text"  value="$telefono" id="Texto7" onkeypress="return valida(event)" />
Correo</br> 
